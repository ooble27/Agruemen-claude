...
export const ARTICLES: Article[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Des plateformes comme Mamakaasa, lancée en 2022, ont profité de cette infrastructure pour créer des marketplaces directes. Le résultat : les producteurs partenaires constatent en moyenne +40% de revenus dès la première année." },
      { type: "list", items: [
      ...
      { type: "image", src: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=1200&h=600&fit=crop&auto=format", alt: "Producteur sénégalais", caption: "Un producteur partenaire Mamakaasa dans sa exploitation à Thiès" },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Achetez en grande quantité de novembre à mars et apprenez à conserver (séchage, congélation, fermentation). Avec Mamakaasa, vous achetez directement au producteur, ce qui lisse naturellement les prix en éliminant les intermédiaires." },
    ],
  },
  {
    id: 4,
    ...
    excerpt: "Rencontre avec Fatou Ba, 38 ans, productrice de tomates qui a rejoint Mamakaasa il y a deux ans. Depuis, ses revenus ont augmenté de 45% et elle emploie 3 personnes.",
    author: { name: "Équipe Mamakaasa", role: "Rédaction" },
    date: "10 avril 2026",
    readTime: "7 min",
    image: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=1600&h=900&fit=crop&auto=format",
    content: [
      { type: "paragraph", text: "Il est 6h30 du matin à Thiès. Fatou Ba est déjà dans ses champs. Ses 2 hectares de tomates et d'aubergines brillent sous la rosée matinale. À 38 ans, cette mère de quatre enfants est devenue l'une des productrices les plus actives de la plateforme Mamakaasa." },
      { type: "heading", text: "Avant Mamakaasa : la galère des intermédiaires" },
      ...
      { type: "quote", text: "Quand un agent Mamakaasa m'a contactée en janvier 2024, j'étais sceptique. J'avais vu trop d'intermédiaires promettre monts et merveilles. Mais là, c'était différent : je fixais mes propres prix.", author: "Fatou Ba, productrice à Thiès" },
      ...
      { type: "list", items: [
        ...
        "Formation en gestion comptable via Mamakaasa Academy",
        "Accès au microcrédit agricole via les partenaires Mamakaasa",
      ]},
      ...
      { type: "paragraph", text: "Le message de Fatou aux autres productrices qui hésitent ? « N'attendez pas. Chaque mois que vous passez avec les collecteurs, c'est de l'argent que vous perdez. Rejoignez Mamakaasa et reprenez le contrôle de votre production. »" },
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content: [
      ...
      { type: "list", items: [
        ...
        "Programme Mamakaasa Invest : accès au crédit via nos partenaires financiers",
      ]},
    ],
  },
  {
