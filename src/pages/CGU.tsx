...
const SECTIONS = [
  {
    title: "1. Objet",
    content: `Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de la plateforme Agrumen (site web et application mobile) par tout utilisateur, qu'il soit acheteur ou visiteur.
...
En utilisant la plateforme, vous acceptez sans réserve ces conditions. Si vous n'acceptez pas ces CGU, veuillez cesser d'utiliser notre service.`,
  },
  {
    ...
    content: `Agrumen est une marketplace en ligne qui met en relation des acheteurs et des producteurs agricoles sénégalais. La plateforme permet :
...
Agrumen agit en tant qu'intermédiaire entre les acheteurs et les producteurs partenaires.`,
  },
  {
...
• Informer immédiatement Agrumen de toute utilisation non autorisée de son compte

Un seul compte par personne est autorisé. Agrumen se réserve le droit de suspendre tout compte en cas d'utilisation frauduleuse.`,
  },
  {
...
Agrumen se réserve le droit d'annuler toute commande suspecte ou frauduleuse.`,
  },
  {
    title: "5. Livraison",
...
La responsabilité de la livraison est transférée à l'acheteur à la réception de la commande. En cas de problème à la livraison, le support Agrumen est disponible via la page Contact.`,
  },
  {
...
Après vérification, Agrumen procède au remplacement ou au remboursement du produit concerné dans un délai de 48 heures ouvrées. Les frais de livraison sont remboursés uniquement en cas d'erreur de notre part.`,
  },
  {
...
• Porter atteinte à l'infrastructure technique d'Agrumen

Tout manquement peut entraîner la suspension ou la résiliation du compte.`,
  },
  {
    title: "8. Propriété intellectuelle",
    content: `L'ensemble des éléments de la plateforme (logo, design, textes, photos, fonctionnalités) sont la propriété exclusive d'Agrumen et sont protégés par les droits de propriété intellectuelle applicables.

Toute reproduction, représentation ou utilisation sans autorisation préalable écrite d'Agrumen est interdite.`,
  },
  {
    title: "9. Limitation de responsabilité",
    content: `Agrumen met tout en œuvre pour garantir la disponibilité et la qualité de son service mais ne saurait être tenu responsable des interruptions temporaires, des erreurs techniques ou des dommages indirects liés à l'utilisation de la plateforme.

La responsabilité d'Agrumen est limitée au montant de la commande concernée.`,
  },
  {
    title: "10. Modification des CGU",
    content: `Agrumen se réserve le droit de modifier ces CGU à tout moment. Les utilisateurs sont informés par email ou via la plateforme. La poursuite de l'utilisation du service après modification vaut acceptation des nouvelles conditions.
            ...
            <article className="flex-1 min-w-0 space-y-10">
              <div className="p-5 rounded-xl bg-surface-container-lowest border border-border/30">
                <p className="font-body text-sm text-on-surface-variant leading-relaxed">
                  En utilisant la plateforme Agrumen, vous acceptez les présentes conditions générales d'utilisation.
